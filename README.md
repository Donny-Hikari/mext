...
Mext is a text template language.
...
The section [Syntax](#Syntax) below best illustrates the purpose of this language. Check out the source file [readme_src/README.mext](readme_src/README.mext).
